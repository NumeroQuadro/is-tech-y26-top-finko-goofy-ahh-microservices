...
public class RabbitConfiguration {
    public final static String registerNewCatQueueName = "registerNewCatQueue";
    ...
    public final static String addFriendToCatQueueName = "addFriendToCatQueue";
    public final static String getCatIdsAssociatedWithOwnerName = "getCatIdsAssociatedWithOwner";
    public final static String getCatDetailedInfoByListIdsAndColorName = "getCatDetailedInfoByListIdsAndColor";
    ...
    @Bean
    public Queue registerNewCatQueue() {
        return new Queue(registerNewCatQueueName);
    }
    @Bean
    public Queue addFriendToCatQueue() {
        return new Queue(addFriendToCatQueueName);
    }
    @Bean
    ...
    @Bean
    public Queue getCatDetailedInfoByListIdsAndColor() {
        return new Queue(getCatDetailedInfoByListIdsAndColorName);
    }
}
